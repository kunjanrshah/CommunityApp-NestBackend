...
export interface UserDTO {
  ...
  userLocation?: Nullable<UserLocationDTO>;
...
export interface MastersCountResponseDTO {
  success: boolean;
  message: string;
...
export interface IQuery {
  ...
  getCitiesByState(
    ...
    date?: Nullable<string>,
    subCommunityId?: Nullable<number>,
  ): CityResponseDto | Promise<CityResponseDto>;
...
export interface IMutation {
  ...
  statusChange(
    data: StatusChangeInputDto,
  ): StatusChangeResponseDto | Promise<StatusChangeResponseDto>;
